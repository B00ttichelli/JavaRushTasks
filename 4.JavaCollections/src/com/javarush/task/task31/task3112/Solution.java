...
public class Solution {
    ...
    public static Path downloadFile(String urlString, Path downloadDirectory) throws IOException {
        ...
        Path tmp = Files.createTempFile("tmp", ".html");
        Files.copy(url.openStream(),tmp);
        Path downloadedFilePath = downloadDirectory.resolve(Paths.get(url.getFile()).getFileName());
        Files.move(tmp,downloadedFilePath);
