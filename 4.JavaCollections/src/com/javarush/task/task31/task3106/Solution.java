    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length > 0) {
         ...
         File file = new File(args[0]);
            ...
            ZipInputStream zipInputStream = new ZipInputStream(new SequenceInputStream(Collections.enumeration(fileInputStreamList)));
            ZipEntry zipEntry = zipInputStream.getNextEntry();

            byte[] bytes = new byte[zipInputStream.available()];
            zipInputStream.read(bytes);
            OutputStream os = new BufferedOutputStream(new FileOutputStream(file));
            os.write(bytes,0,zipInputStream.available());
            os.close();
...
/// решение которое принимает валидатор
