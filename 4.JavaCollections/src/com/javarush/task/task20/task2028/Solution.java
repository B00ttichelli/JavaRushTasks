...
/*        System.out.println(list.size() + " expect 15");*/
        list.remove("3");
/*        System.out.println(list.remove("3"));*/
/*        System.out.println(list.size() + " expect 14");*/
 ...
 /*       System.out.println(list.size() + " expect 15");*/
        ...
        list.remove("5");
        list.remove("6");
/*        System.out.println(list.size() + " expect 2");*/
        System.out.println("Expected: true. Actual: " + list.add("20"));
  /*      System.out.println(list.size() + " expect 3");*/
