...
5. Метод containsBones() в классе Finger должен возвращать строку "Yes", если такой же метод в классе BodyPart возвращает
...
если метод containsBones() возвращает "Yes" для этой части тела. Если "No", то строку формата "name(имя части тела) не содержит кости".
*/
