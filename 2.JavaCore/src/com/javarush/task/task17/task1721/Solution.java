...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        allLines = Files.newBufferedReader(Paths.get(bufferedReader.readLine())).lines().collect(Collectors.toList());
        forRemoveLines = Files.newBufferedReader(Paths.get(bufferedReader.readLine())).lines().collect(Collectors.toList());
        try {
            solution.joinData();
