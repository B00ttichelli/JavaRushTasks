...
public class Solution {
    public static void main(String[] args) throws IOException {
        ...
        Map<Integer,Integer> contTable = new TreeMap<>();

        while (fileInputStream.available()>0){
            contTable.compute(fileInputStream.read(), (key,value)->((value==null)?1:value+1));
        }
        String separator = " ";
        contTable.forEach((key,value)-> System.out.println((char) key.intValue()+separator+value));
